...
export interface Procedure {
  ...
  price_comparison_us: number | null;
...
export const procedures: Procedure[] = [
  // Face & Neck (6 procedures)
  {
    ...
    recovery_days_es: '15 días',
    recovery_days_en: '15 days',
  ...
  // Body Contouring (6 procedures)
  {
    ...
    description_es: 'Liposucción 360° en piernas, brazos y abdomen.',
    description_en: '360° Liposuction on legs, arms and abdomen.',
    price_usd: 12571,
    price_comparison_us: 35917,
