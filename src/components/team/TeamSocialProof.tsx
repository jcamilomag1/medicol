            ...
            >
              <Card className="relative overflow-hidden h-full hover:shadow-md transition-shadow">
                <CardContent className="pt-4">
                  <div className="relative mx-auto flex aspect-square size-16 md:size-20 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <stat.icon className="m-auto size-8 md:size-10 text-accent" strokeWidth={1.5} />
                  </div>
