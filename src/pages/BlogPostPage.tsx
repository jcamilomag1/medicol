            ...
            <div className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-foreground prose-strong:text-foreground prose-li:text-foreground">
              <ReactMarkdown
                ...
                components={{
                  ...
                  h1: ({node, ...props}) => <h1 className="text-3xl font-bold mt-8 mb-4 font-serif" {...props} />,
                  h2: ({node, ...props}) => <h2 className="text-2xl font-bold mt-6 mb-3 font-serif" {...props} />,
                  h3: ({node, ...props}) => <h3 className="text-xl font-bold mt-4 mb-2 font-serif" {...props} />,
