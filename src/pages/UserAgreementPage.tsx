...
const UserAgreementPage = () => {
  return (
    <>
      <Helmet>
        <title>User Agreement - Isoesthetic Medical Tourism</title>
        <meta name="description" content="User Agreement Contract for Isoesthetic Medical Tourism - Terms and conditions for our medical tourism services." />
      ...
      >
        <div className="space-y-8">
          <section>
            <p className="text-lg">
              This User Agreement ("Agreement") is entered into between Isoesthetic Medical Tourism ("Isoesthetic," "we," "us," or "our") and the individual ("Client," "you," or "your") seeking medical tourism services. By engaging our services, you agree to the terms and conditions outlined below.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">1. Scope of Services</h2>
            <p className="mb-3">Isoesthetic provides medical tourism facilitation services, which may include but are not limited to:</p>
            ...
            <p className="mt-3">
              <strong>Important:</strong> Isoesthetic acts as a facilitator and is not a healthcare provider. All medical treatments are performed by licensed, independent healthcare professionals.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Isoesthetic partners with accredited hospitals, clinics, and licensed medical professionals.</li>
              <li>The healthcare providers are solely responsible for the medical services provided.</li>
              <li>Isoesthetic does not guarantee specific medical outcomes or results.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Isoesthetic will facilitate communication between clients and healthcare providers, but final medical decisions rest with the client and their chosen medical professional.</li>
          ...
          <section>
            ...
            <p className="mb-3">
              Isoesthetic charges a facilitation fee for coordinating services. This fee is separate from medical, travel, and accommodation costs.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Isoesthetic assists in arranging flights, accommodations, and transportation but is not responsible for delays, cancellations, or disruptions caused by airlines, hotels, or third-party service providers.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Isoesthetic is not liable for any medical complications, adverse outcomes, or malpractice by healthcare providers.</li>
              <li>Isoesthetic is not responsible for losses or damages resulting from travel disruptions, accommodation issues, or unforeseen events beyond our control (e.g., natural disasters, pandemics, political instability).</li>
              <li>Clients acknowledge that medical procedures carry inherent risks and agree to hold Isoesthetic harmless for any complications arising from treatments.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Isoesthetic does not provide insurance coverage and is not responsible for claims denied by insurance providers.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Isoesthetic is committed to protecting client privacy in accordance with our Privacy Policy.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Clients agree to waive their right to pursue class-action lawsuits against Isoesthetic.</li>
            </ul>
          </section>
          ...
          <div className="mt-12 p-6 bg-primary/5 border border-primary/20 rounded-lg space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              By using Isoesthetic's services, you acknowledge that you have read, understood, and agree to be bound by the terms of this User Agreement. If you do not agree with any part of this Agreement, you should not proceed with our services.
            </p>
            <p className="text-sm text-muted-foreground">
              <strong>Note:</strong> Isoesthetic reserves the right to modify this Agreement at any time. Clients will be notified of significant changes, and continued use of our services constitutes acceptance of the updated terms.
            </p>
          </div>
        </div>
      </LegalLayout>
